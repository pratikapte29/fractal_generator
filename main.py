...
class FractalGeneratorUI(QMainWindow):
    ...
    def create_parameter_groups(self, layout):
        ...
        self.c_real.setDecimals(3)
        self.c_real.setSingleStep(0.01)
    ...
    def create_control_buttons(self, layout):
        ...
        self.generate_button.setEnabled(False)  # Disabled until fractal is selected
    ...
    def create_display_panel(self):
        ...
        # Add zoom info label
        self.zoom_label = QLabel("Zoom: 100% | Click and drag to pan")
        self.zoom_label.setAlignment(Qt.AlignCenter)
        self.zoom_label.setStyleSheet("color: #aaaaaa; padding: 5px;")
    ...
    def show_parameters_for_fractal(self, fractal_type):
        ...
        complex_fractals = [
            "Mandelbrot Set", "Julia Set", "Newton Fractal", 
            "Burning Ship", "Phoenix Fractal"
        ]
        
        geometric_fractals = [
            "Koch Snowflake", "Sierpinski Triangle", "Dragon Curve",
            "Barnsley Fern", "Cantor Set", "Levy C Curve", 
            "Tree Fractal", "Hilbert Curve", "Apollonian Gasket"
        ]
    ...
    def on_generate_clicked(self):
        ...
        print(f"Generating {fractal_type} with current parameters...")
        # Here you would call your fractal generation functions
    ...
    def on_save_clicked(self):
        ...
        print("Saving fractal image...")
        # Here you would implement image saving functionality
